...
pub type CHKSIZE_R = crate::FieldReader<u8, CHKSIZE_A>;
...
pub type CHKSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_SPEC, u8, CHKSIZE_A, 2, O>;
...
impl R {
    ...
    #[doc = "Bits 4:5 - DMA Channel Read and Write Chunk Size"]
    #[inline(always)]
    pub fn chksize(&self) -> CHKSIZE_R {
        CHKSIZE_R::new(((self.bits >> 4) & 3) as u8)
    }
