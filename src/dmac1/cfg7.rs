#[doc = "Register `CFG7` reader"]
pub struct R(crate::R<CFG7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CFG7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CFG7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CFG7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CFG7` writer"]
pub struct W(crate::W<CFG7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CFG7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CFG7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CFG7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SRC_PER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG7_SPEC, u8, u8, 4, O>;
...
pub type DST_PER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG7_SPEC, u8, u8, 4, O>;
#[doc = "Field `SRC_REP` reader - Source Reloaded from Previous"]
pub type SRC_REP_R = crate::BitReader<SRC_REP_A>;
#[doc = "Source Reloaded from Previous\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SRC_REP_A {
    #[doc = "0: When automatic mode is activated, source address is contiguous between two buffers."]
    CONTIGUOUS_ADDR = 0,
    #[doc = "1: When automatic mode is activated, the source address and the control register are reloaded from previous transfer."]
    RELOAD_ADDR = 1,
}
impl From<SRC_REP_A> for bool {
    #[inline(always)]
    fn from(variant: SRC_REP_A) -> Self {
        variant as u8 != 0
    }
}
impl SRC_REP_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> SRC_REP_A {
        match self.bits {
            false => SRC_REP_A::CONTIGUOUS_ADDR,
            true => SRC_REP_A::RELOAD_ADDR,
        }
    }
    #[doc = "Checks if the value of the field is `CONTIGUOUS_ADDR`"]
    #[inline(always)]
    pub fn is_contiguous_addr(&self) -> bool {
        *self == SRC_REP_A::CONTIGUOUS_ADDR
    }
    #[doc = "Checks if the value of the field is `RELOAD_ADDR`"]
    #[inline(always)]
    pub fn is_reload_addr(&self) -> bool {
        *self == SRC_REP_A::RELOAD_ADDR
    }
}
#[doc = "Field `SRC_REP` writer - Source Reloaded from Previous"]
pub type SRC_REP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG7_SPEC, SRC_REP_A, O>;
impl<'a, const O: u8> SRC_REP_W<'a, O> {
    #[doc = "When automatic mode is activated, source address is contiguous between two buffers."]
    #[inline(always)]
    pub fn contiguous_addr(self) -> &'a mut W {
        self.variant(SRC_REP_A::CONTIGUOUS_ADDR)
    }
    #[doc = "When automatic mode is activated, the source address and the control register are reloaded from previous transfer."]
    #[inline(always)]
    pub fn reload_addr(self) -> &'a mut W {
        self.variant(SRC_REP_A::RELOAD_ADDR)
    }
}
...
pub type SRC_H2SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG7_SPEC, SRC_H2SEL_A, O>;
...
#[doc = "Field `DST_REP` reader - Destination Reloaded from Previous"]
pub type DST_REP_R = crate::BitReader<DST_REP_A>;
#[doc = "Destination Reloaded from Previous\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DST_REP_A {
    #[doc = "0: When automatic mode is activated, destination address is contiguous between two buffers."]
    CONTIGUOUS_ADDR = 0,
    #[doc = "1: When automatic mode is activated, the destination and the control register are reloaded from the pre-vious transfer."]
    RELOAD_ADDR = 1,
}
impl From<DST_REP_A> for bool {
    #[inline(always)]
    fn from(variant: DST_REP_A) -> Self {
        variant as u8 != 0
    }
}
impl DST_REP_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> DST_REP_A {
        match self.bits {
            false => DST_REP_A::CONTIGUOUS_ADDR,
            true => DST_REP_A::RELOAD_ADDR,
        }
    }
    #[doc = "Checks if the value of the field is `CONTIGUOUS_ADDR`"]
    #[inline(always)]
    pub fn is_contiguous_addr(&self) -> bool {
        *self == DST_REP_A::CONTIGUOUS_ADDR
    }
    #[doc = "Checks if the value of the field is `RELOAD_ADDR`"]
    #[inline(always)]
    pub fn is_reload_addr(&self) -> bool {
        *self == DST_REP_A::RELOAD_ADDR
    }
}
#[doc = "Field `DST_REP` writer - Destination Reloaded from Previous"]
pub type DST_REP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG7_SPEC, DST_REP_A, O>;
impl<'a, const O: u8> DST_REP_W<'a, O> {
    #[doc = "When automatic mode is activated, destination address is contiguous between two buffers."]
    #[inline(always)]
    pub fn contiguous_addr(self) -> &'a mut W {
        self.variant(DST_REP_A::CONTIGUOUS_ADDR)
    }
    #[doc = "When automatic mode is activated, the destination and the control register are reloaded from the pre-vious transfer."]
    #[inline(always)]
    pub fn reload_addr(self) -> &'a mut W {
        self.variant(DST_REP_A::RELOAD_ADDR)
    }
}
...
pub type DST_H2SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG7_SPEC, DST_H2SEL_A, O>;
...
pub type SOD_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG7_SPEC, SOD_A, O>;
...
pub type LOCK_IF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG7_SPEC, LOCK_IF_A, O>;
...
pub type LOCK_B_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG7_SPEC, LOCK_B_A, O>;
...
pub type LOCK_IF_L_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG7_SPEC, LOCK_IF_L_A, O>;
...
pub type AHB_PROT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG7_SPEC, u8, u8, 3, O>;
...
pub type FIFOCFG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG7_SPEC, u8, FIFOCFG_A, 2, O>;
...
impl R {
    ...
    #[doc = "Bit 8 - Source Reloaded from Previous"]
    #[inline(always)]
    pub fn src_rep(&self) -> SRC_REP_R {
        SRC_REP_R::new(((self.bits >> 8) & 1) != 0)
    }
    ...
    #[doc = "Bit 12 - Destination Reloaded from Previous"]
    #[inline(always)]
    pub fn dst_rep(&self) -> DST_REP_R {
        DST_REP_R::new(((self.bits >> 12) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 8 - Source Reloaded from Previous"]
    #[inline(always)]
    pub fn src_rep(&mut self) -> SRC_REP_W<8> {
        SRC_REP_W::new(self)
    }
    #[doc = "Bit 9 - Software or Hardware Selection for the Source"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - Destination Reloaded from Previous"]
    #[inline(always)]
    pub fn dst_rep(&mut self) -> DST_REP_W<12> {
        DST_REP_W::new(self)
    }
    #[doc = "Bit 13 - Software or Hardware Selection for the Destination"]
    #[inline(always)]
...
#[doc = "DMAC Channel Configuration Register (ch_num = 7)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cfg7](index.html) module"]
pub struct CFG7_SPEC;
impl crate::RegisterSpec for CFG7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cfg7::R](R) reader structure"]
impl crate::Readable for CFG7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cfg7::W](W) writer structure"]
impl crate::Writable for CFG7_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CFG7 to value 0x0100_0000"]
impl crate::Resettable for CFG7_SPEC {
    #[inline(always)]
