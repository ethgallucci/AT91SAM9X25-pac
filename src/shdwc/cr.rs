...
#[doc = "Field `SHDW` writer - Shutdown Command"]
pub type SHDW_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, bool, O>;
#[doc = "Field `KEY` writer - Password"]
pub type KEY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_SPEC, u8, u8, 8, O>;
impl W {
    #[doc = "Bit 0 - Shutdown Command"]
    #[inline(always)]
    pub fn shdw(&mut self) -> SHDW_W<0> {
        SHDW_W::new(self)
    }
