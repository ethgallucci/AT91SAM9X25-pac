#[doc = "Register `PMC_PCSR` reader"]
pub struct R(crate::R<PMC_PCSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PMC_PCSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PMC_PCSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PMC_PCSR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Peripheral Clock Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pmc_pcsr](index.html) module"]
pub struct PMC_PCSR_SPEC;
impl crate::RegisterSpec for PMC_PCSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pmc_pcsr::R](R) reader structure"]
impl crate::Readable for PMC_PCSR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PMC_PCSR to value 0"]
impl crate::Resettable for PMC_PCSR_SPEC {
    #[inline(always)]
