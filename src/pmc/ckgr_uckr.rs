...
#[doc = "Field `BIASEN` reader - UTMI BIAS Enable"]
pub type BIASEN_R = crate::BitReader<bool>;
#[doc = "Field `BIASEN` writer - UTMI BIAS Enable"]
pub type BIASEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CKGR_UCKR_SPEC, bool, O>;
#[doc = "Field `BIASCOUNT` reader - UTMI BIAS Start-up Time"]
pub type BIASCOUNT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `BIASCOUNT` writer - UTMI BIAS Start-up Time"]
pub type BIASCOUNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CKGR_UCKR_SPEC, u8, u8, 4, O>;
impl R {
    ...
    #[doc = "Bit 24 - UTMI BIAS Enable"]
    #[inline(always)]
    pub fn biasen(&self) -> BIASEN_R {
        BIASEN_R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bits 28:31 - UTMI BIAS Start-up Time"]
    #[inline(always)]
    pub fn biascount(&self) -> BIASCOUNT_R {
        BIASCOUNT_R::new(((self.bits >> 28) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bit 16 - UTMI PLL Enable"]
    ...
    #[doc = "Bit 24 - UTMI BIAS Enable"]
    #[inline(always)]
    pub fn biasen(&mut self) -> BIASEN_W<24> {
        BIASEN_W::new(self)
    }
    #[doc = "Bits 28:31 - UTMI BIAS Start-up Time"]
    #[inline(always)]
    pub fn biascount(&mut self) -> BIASCOUNT_W<28> {
        BIASCOUNT_W::new(self)
    }
...
#[doc = "`reset()` method sets CKGR_UCKR to value 0x1020_0000"]
