...
#[doc = "Field `USBS` reader - USB OHCI Input Clock Selection"]
pub type USBS_R = crate::BitReader<bool>;
#[doc = "Field `USBS` writer - USB OHCI Input Clock Selection"]
pub type USBS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PMC_USB_SPEC, bool, O>;
#[doc = "Field `USBDIV` reader - Divider for USB OHCI Clock."]
pub type USBDIV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USBDIV` writer - Divider for USB OHCI Clock."]
pub type USBDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PMC_USB_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bit 0 - USB OHCI Input Clock Selection"]
    #[inline(always)]
    pub fn usbs(&self) -> USBS_R {
        USBS_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 8:11 - Divider for USB OHCI Clock."]
    #[inline(always)]
