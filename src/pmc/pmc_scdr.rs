...
#[doc = "Field `PCK` writer - Processor Clock Disable"]
pub type PCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PMC_SCDR_SPEC, bool, O>;
#[doc = "Field `DDRCK` writer - DDR Clock Disable"]
pub type DDRCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PMC_SCDR_SPEC, bool, O>;
#[doc = "Field `SMDCK` writer - SMD Clock Disable"]
pub type SMDCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, PMC_SCDR_SPEC, bool, O>;
#[doc = "Field `UHP` writer - USB Host OHCI Clock Disable"]
pub type UHP_W<'a, const O: u8> = crate::BitWriter<'a, u32, PMC_SCDR_SPEC, bool, O>;
...
impl W {
    #[doc = "Bit 0 - Processor Clock Disable"]
    #[inline(always)]
    pub fn pck(&mut self) -> PCK_W<0> {
        PCK_W::new(self)
    }
    #[doc = "Bit 2 - DDR Clock Disable"]
    #[inline(always)]
    pub fn ddrck(&mut self) -> DDRCK_W<2> {
        DDRCK_W::new(self)
    }
    #[doc = "Bit 4 - SMD Clock Disable"]
    #[inline(always)]
    pub fn smdck(&mut self) -> SMDCK_W<4> {
        SMDCK_W::new(self)
    }
    #[doc = "Bit 6 - USB Host OHCI Clock Disable"]
    #[inline(always)]
