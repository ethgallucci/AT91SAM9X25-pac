...
pub type READ_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE4_SPEC, bool, O>;
#[doc = "Field `WRITE_MODE` reader - "]
pub type WRITE_MODE_R = crate::BitReader<bool>;
#[doc = "Field `WRITE_MODE` writer - "]
pub type WRITE_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE4_SPEC, bool, O>;
#[doc = "Field `EXNW_MODE` reader - NWAIT Mode"]
pub type EXNW_MODE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EXNW_MODE` writer - NWAIT Mode"]
pub type EXNW_MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MODE4_SPEC, u8, u8, 2, O>;
...
pub type DBW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MODE4_SPEC, u8, u8, 2, O>;
...
pub type PMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE4_SPEC, bool, O>;
#[doc = "Field `PS` reader - Page Size"]
pub type PS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PS` writer - Page Size"]
pub type PS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MODE4_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
#[doc = "`reset()` method sets MODE4 to value 0x1000_1000"]
