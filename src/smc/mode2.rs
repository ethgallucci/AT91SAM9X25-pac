...
pub type EXNW_MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MODE2_SPEC, u8, u8, 2, O>;
...
pub type DBW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MODE2_SPEC, u8, u8, 2, O>;
...
pub type PS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MODE2_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
#[doc = "`reset()` method sets MODE2 to value 0x1000_1000"]
