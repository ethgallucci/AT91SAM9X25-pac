...
#[doc = "Field `COMMTX` reader - Mask COMMTX Interrupt"]
pub type COMMTX_R = crate::BitReader<bool>;
#[doc = "Field `COMMRX` reader - Mask COMMRX Interrupt"]
...
impl R {
    ...
    #[doc = "Bit 30 - Mask COMMTX Interrupt"]
    #[inline(always)]
    pub fn commtx(&self) -> COMMTX_R {
        COMMTX_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Mask COMMRX Interrupt"]
    #[inline(always)]
