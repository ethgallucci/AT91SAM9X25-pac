...
#[doc = "Field `COMMTX` writer - Enable COMMTX (from ARM) Interrupt"]
pub type COMMTX_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `COMMRX` writer - Enable COMMRX (from ARM) Interrupt"]
pub type COMMRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
impl W {
    ...
    #[doc = "Bit 30 - Enable COMMTX (from ARM) Interrupt"]
    #[inline(always)]
    pub fn commtx(&mut self) -> COMMTX_W<30> {
        COMMTX_W::new(self)
    }
    #[doc = "Bit 31 - Enable COMMRX (from ARM) Interrupt"]
    #[inline(always)]
