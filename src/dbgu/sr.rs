...
#[doc = "Field `COMMTX` reader - Debug Communication Channel Write Status"]
pub type COMMTX_R = crate::BitReader<bool>;
#[doc = "Field `COMMRX` reader - Debug Communication Channel Read Status"]
pub type COMMRX_R = crate::BitReader<bool>;
impl R {
    ...
    #[doc = "Bit 30 - Debug Communication Channel Write Status"]
    #[inline(always)]
    pub fn commtx(&self) -> COMMTX_R {
        COMMTX_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Debug Communication Channel Read Status"]
    #[inline(always)]
    pub fn commrx(&self) -> COMMRX_R {
        COMMRX_R::new(((self.bits >> 31) & 1) != 0)
    }
}
