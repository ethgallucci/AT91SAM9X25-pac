...
pub type SRC_REP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG3_SPEC, SRC_REP_A, O>;
...
pub type DST_REP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG3_SPEC, DST_REP_A, O>;
