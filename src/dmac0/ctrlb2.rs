...
pub type SIF_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRLB2_SPEC, u8, SIF_A, 2, O>;
...
pub type DIF_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRLB2_SPEC, u8, DIF_A, 2, O>;
...
pub type SRC_PIP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRLB2_SPEC, SRC_PIP_A, O>;
...
pub type DST_PIP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRLB2_SPEC, DST_PIP_A, O>;
...
pub type FC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRLB2_SPEC, u8, FC_A, 3, O>;
...
pub type AUTO_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRLB2_SPEC, AUTO_A, O>;
