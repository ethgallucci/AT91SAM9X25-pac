...
pub type SRC_REP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG1_SPEC, SRC_REP_A, O>;
...
pub type DST_REP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG1_SPEC, DST_REP_A, O>;
