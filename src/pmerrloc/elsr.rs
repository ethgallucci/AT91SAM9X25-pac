...
#[doc = "Field `BUSY` reader - Error Location Engine Busy"]
pub type BUSY_R = crate::BitReader<bool>;
#[doc = "Field `BUSY` writer - Error Location Engine Busy"]
pub type BUSY_W<'a, const O: u8> = crate::BitWriter<'a, u32, ELSR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Error Location Engine Busy"]
    #[inline(always)]
